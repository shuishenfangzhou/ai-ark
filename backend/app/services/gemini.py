"""
Gemini API 服务 - 语义搜索与工具推荐
使用 Gemini Embedding 实现基于向量相似度的智能推荐
"""
...
try:
    ...
    from google.genai.types import EmbedContentConfig, GoogleSearchRetrieval
...
class GeminiService:
    ...
    def __init__(self):
        ...
        if self.api_key and GOOGLE_GENAI_AVAILABLE:
            ...
            self.client = None
            print("⚠️ 使用模拟模式 (请配置 GOOGLE_API_KEY)")
